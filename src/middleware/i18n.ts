...
import { TranslationCache, ExpressCallBack } from '../types'
...
export const i18nextXhr = (req: any, res: any) => {
...
export const refreshTranslations: ExpressCallBack = async (_req: any, res: any) => {
